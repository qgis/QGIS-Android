...
macro( __DETECT_TOOLCHAIN_MACHINE_NAME _var _root )
 ...
 message( INFO "gcc exe path (${_root}/bin/*-gcc${TOOL_OS_SUFFIX}) " )
 __LIST_FILTER( __gccExePath "bin/[.].*-gcc${TOOL_OS_SUFFIX}$" )
 list( LENGTH __gccExePath __gccExePathsCount )
 message( INFO "count (${__gccExePath}) " )
 if( NOT __gccExePathsCount EQUAL 1 )
  message( WARNING "Could not uniquely determine machine name for compiler from ${_root} (${TOOL_OS_SUFFIX})." )
  set( ${_var} "" )
 else()
...
set( CMAKE_FIND_ROOT_PATH_CUSTOM_APPEND CACHE STRING "Add custom path to the end of CMAKE_FIND_ROOT_PATH" )
