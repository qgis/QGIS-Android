...
rpl -R -e libqgis_core.so.1.9.0 "libqgis_core.so\x00\x00\x00\x00\x00\x00" $APK_LIBS_DIR
rpl -R -e libqgis_gui.so.1.9.0 "libqgis_gui.so\x00\x00\x00\x00\x00\x00" $APK_LIBS_DIR
rpl -R -e libqgis_analysis.so.1.9.0 "libqgis_analysis.so\x00\x00\x00\x00\x00\x00" $APK_LIBS_DIR
rpl -R -e libqgissqlanyconnection.so.1.9.0 "libqgissqlanyconnection.so\x00\x00\x00\x00\x00\x00" $APK_LIBS_DIR
